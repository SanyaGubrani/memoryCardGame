...
const HomePage: React.FC = () => {
    const buttonStyles = `text-xl md:text-3xl text-center bg-gradient-to-r
                        ...
                        whitespace-nowrap w-32 md:w-56 tracking-widest px-6 py-3 md:py-6 m-3
    ...
    const headingContent = (
        <div className="flex items-center justify-center gap-3">
            <img src={bulb} alt="bulb" className="size-9 md:size-14" />
            Memory Game
            <img src={bulb} alt="bulb" className="size-9 md:size-14" />
        </div>
    );
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-2 md:gap-12 min-h-screen -mt-10 p-5">
            <GameHeading
                headingText={headingContent}
                className="pt-8 m-5 justify-center"
            />
